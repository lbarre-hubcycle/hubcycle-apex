...
const DICT = {
  ...
  "me.title": { en: "Cockpit", fr: "Cockpit" },
  "me.sub": {
  ...
  "settings.sub": {
    en: "Teams, team assignment and managers.",
    fr: "Équipes, affectations aux équipes et managers.",
  },
  "settings.teams": { en: "Teams", fr: "Équipes" },
  "settings.deleteTeam": { en: "Delete", fr: "Supprimer" },
  "settings.deleteTeamConfirm": {
    en: "Delete this team? Its members will simply become unassigned.",
    fr: "Supprimer cette équipe ? Ses membres deviendront simplement non affectés.",
  },
  ...
  "section.cockpit.desc": { en: "Your profile, strengths and development focus.", fr: "Votre profil, vos forces, votre axe de développement." },
  "section.crew.desc": { en: "Team maps, coaching and growth of your people.", fr: "Cartes d'équipe, coaching et développement de vos équipes." },
  "section.company.desc": { en: "Organizational analytics, referential and methodology.", fr: "Analyses organisationnelles, référentiel et méthodologie." },
  ...
  "home.admin": { en: "Sign in", fr: "Connexion" },
  ...
  "dyn.download": { en: "Download the map (PDF)", fr: "Télécharger la carte (PDF)" },
  "insights.matrix": { en: "Talent matrix — Role fit × Culture fit", fr: "Matrice des talents — Adéquation poste × Alignement culturel" },
  "insights.matrixSub": {
    en: "Each person is placed by their role-match score (1–5) and culture-fit score (1–5). Click a name to open the report.",
    fr: "Chaque personne est placée selon son score d’adéquation au poste (1–5) et son alignement culturel (1–5). Cliquez sur un prénom pour ouvrir le rapport.",
  },
  "insights.roleFit": { en: "Role fit", fr: "Adéquation poste" },
  "insights.cultureFit": { en: "Culture fit", fr: "Alignement culturel" },
  "insights.low": { en: "Low", fr: "Faible" },
  "insights.mid": { en: "Mid", fr: "Moyen" },
  "insights.high": { en: "High", fr: "Élevé" },
  "insights.matrixLegend": {
    en: "Thresholds — role fit: high ≥ 4, mid 3–3.9, low < 3 · culture fit: high ≥ 3.7, mid 3–3.69, low < 3.",
    fr: "Seuils — adéquation poste : élevé ≥ 4, moyen 3–3,9, faible < 3 · alignement culturel : élevé ≥ 3,7, moyen 3–3,69, faible < 3.",
  },
  "insights.noRoleFit": {
    en: "person(s) not shown: no role assigned, so no role-match score.",
    fr: "personne(s) non affichée(s) : pas de poste assigné, donc pas de score d’adéquation.",
  },
  "dyn.insights": { en: "Team insights", fr: "Lectures d’équipe" },
  "dyn.scatter": { en: "Team positioning", fr: "Positionnement de l’équipe" },
