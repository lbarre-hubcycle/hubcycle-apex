...
const GROUPS: {
  ...
  items: { href: string; key: "nav.me" | "nav.goals" | "nav.feedback" | "nav.dynamics" | "nav.coach" | "nav.growth" | "nav.insights" | "nav.referential" | "nav.methodology" | "nav.recruit" | "nav.compare" | "nav.settings"; roles: Role[] }[];
}[] = [
  {
    id: "cockpit",
    key: "nav.cockpit",
